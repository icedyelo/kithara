...
<body class="templatemo-bg-image-2">
    ...
    <div class="container">
        <div class="col-md-12">			
            <form class="form-horizontal templatemo-contact-form-1" id="productForm" method="POST" action="${pageContext.request.contextPath}/products/update">
                <div class="form-group">
                    <div class="col-md-12">
                        <h1 class="margin-bottom-15 pt-4">Product Update Form</h1>
                ...
                <div class="form-group">
                    <div class="col-md-12">		          	
                        ...
                        <div class="templatemo-input-icon-container">
                            ...
                            <input type="text" class="form-control" value="<c:out value='${productsDetails.productsId}'/>" id="productsId" name="productsId" placeholder="" required>
                        </div>		            		            		            
                    </div>              
                </div>
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="templatemo-input-icon-container">
                            ...
                            <input type="text" class="form-control" value="<c:out value='${productsDetails.productsName}'/>" id="productsName" name="productsName" placeholder="" required>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="templatemo-input-icon-container">
                            ...
                            <input type="text" class="form-control" value="<c:out value='${productsDetails.description}'/>" id="description" name="description" placeholder="" required>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="templatemo-input-icon-container">
                            ...
                            <input type="text" class="form-control" value="<c:out value='${productsDetails.size}'/>" id="size" name="size" placeholder="" required>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="templatemo-input-icon-container">
                            ...
                            <input type="text" class="form-control" value="<c:out value='${productsDetails.price}'/>" id="price" name="price" placeholder="" required>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <div class="templatemo-input-icon-container">
                            ...
                            <input type="text" class="form-control" value="<c:out value='${productsDetails.quantity}'/>" id="quantity" name="quantity" placeholder="" required>
                        </div>
                    </div>
                </div>
