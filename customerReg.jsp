...
<html>
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/css/2signup.css">
        <meta charset="UTF-8">
    ...
    <body>
        <div class="container h-100">
            <div class="d-flex justify-content-center h-100">
                <div class="user_card">
                    <h2><c:out value="${customer.regNotice}"/></h2>
                    <h1>Sign Up</h1>

                   
                    
                    <form class="row g-3" id="signUp" method="POST" action="${pageContext.request.contextPath}/customer/added">
                        <div class="col-md-4">
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-center links">Already have an account? &nbsp;<a href="login.jsp" class="ml-2">Log In</a>
                        </div>
                    </div>
                </div>
            </div>
