            ...
            <div class="container h-100">
                <div class="d-flex justify-content-center h-100">
                    ...
                    <div class="user_card regHeight">
                        ...
                        <h1 class="pb-3 pt-2">Update Information</h1>



                        <form class="row g-3" id="signUp" method="POST" action="${pageContext.request.contextPath}/customer/update">
                            <div class="col-md-4">
                                <label for="validationDefault01" class="form-label">First name</label>
                                <input type="text" class="form-control" id="firstName" value="<c:out value='${customerDetails.firstName}'/>"  name="firstName" placeholder="e.g. Juan" required>

                            </div>
                            <div class="col-md-4">
                                <label for="validationDefault01" class="form-label">Middle name</label>
                                <input type="text" class="form-control" id="middleName" value="<c:out value='${customerDetails.middleName}'/>"  name="middleName"placeholder="Leave blank if none" >

                            </div>
                            <div class="col-md-4">
                                <label for="validationDefault02" class="form-label">Last name</label>
                                <input type="text" class="form-control" id="lastName" value="<c:out value='${customerDetails.lastName}'/>" name ="lastName" placeholder="e.g. Luna" required>

                            </div>
                            <div class="col-md-6">
                                <label for="validationDefault02" class="form-label">Birth date</label>
                                <input type="date" class="form-control" id="birthDate" value="<c:out value='${customerDetails.birthDate}'/>" name="birthDate" required>

                            </div>
                            <div class="col-md-6">
                                <label for="validationDefault02" class="form-label">Mobile Number</label>
                                <input type="tel" class="form-control" id="Mobile" value="<c:out value='${customerDetails.mobile}'/>" name="Mobile" maxlength="11"
                                       placeholder="e.g. 09123456789" required>

                            </div>
                            <div class="col-md-8">
                                <label for="validationDefault03" class="form-label">Address</label>
                                <input type="text" class="form-control" id="Address" value="<c:out value='${customerDetails.address}'/>" name="Address" placeholder="e.g. 7401 Georgia 26 Montezuma Georgia United States" required>
                            ...
                            <div class="col-md-4 ">
                                ...
                                <select class="form-select " aria-label="Default select example"  id="userRole" name="userRole">
                                    <option selected><c:out value='${customerDetails.userRole}'/></option>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group"> 
                                    ...
                                    <input type="text" class="form-control" id="userName" name="userName" value="<c:out value='${customerDetails.userId}'/>" aria-describedby="inputGroupPrepend2" required>

                                </div>
                            </div>
                            <div class="col-md-4">
                                <label for="validationDefault01" class="form-label">Password</label>
                                <input type="password" class="form-control" id="Password" value="<c:out value='${customerDetails.password}'/>" name="Password" required>

                            </div>
                            <div class="col-md-4">
                                <label for="validationDefault01" class="form-label">Confirm Password</label>
                                <input type="password" class="form-control" id="confirmPassword" value="<c:out value='${customerDetails.password}'/>" name="Password" required>
